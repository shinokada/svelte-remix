...
<p>
  Here, we import the <Code>MyIcon</Code> component and the <Code>AttachmentLineBusiness</Code> icon.
  By passing the <Code>AttachmentLineBusiness</Code> icon to the <Code>icon</Code> prop of MyIcon, you
  apply the default configuration to the icon.
</p>
