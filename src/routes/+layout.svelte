...
<MetaTags
  {title}
  description="Remix icon set for Svelte"
  openGraph={{
    type: 'website',
    url: 'https://svelte-remix.vercel.app/',
    title: 'Svelte Remix',
    description: 'Remix icon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-remix',
        width: 1200,
        height: 630,
        alt: 'Svelte Remix'
      }
    ],
    site_name: 'Svelte Remix'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Remix',
    description: 'Remix icon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-remix',
    imageAlt: 'Svelte Remix'
  }}
/>
...
<header class="flex-none w-full mx-auto bg-white dark:bg-slate-950">
  <Navbar color="default" fluid let:hidden let:toggle class="dark:bg-slate-950 ">
    ...
    >
      ...
      <NavLi class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-remix">GitHub</NavLi>
...
<Footer footerType="logo" class="dark:bg-slate-950">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    >
      ...
      <FooterLink class="lg:px-2 lg:mb-0" href="https://github.com/shinokada/svelte-remix"
        >GitHub</FooterLink
      >
