<script lang="ts">
  ...
  let {
    ...
    title,
    desc,
    ariaLabel = 'police badge line Others',
    ...restProps
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'police badge line Others'
@prop ...restProps
-->
