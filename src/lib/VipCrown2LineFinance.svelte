<script lang='ts'>
  ...
  let { 
    ...
    desc, 
    class: classname, 
    ariaLabel =  "vip crown 2 line Finance" ,
    ...restProps 
  }: Props = $props();
...
@prop ariaLabel =  "vip crown 2 line Finance"
@prop ...restProps
-->
