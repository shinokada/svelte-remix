<script lang="ts">
  ...
  let {
    ...
    title,
    desc,
    ariaLabel = 'glasses 2 line Others',
    ...restProps
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'glasses 2 line Others'
@prop ...restProps
-->
