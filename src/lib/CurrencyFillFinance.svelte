<script lang='ts'>
  ...
  let { 
    ...
    title,
    desc,
    ariaLabel =  "currency fill Finance" ,
    ...restProps 
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel =  "currency fill Finance"
@prop ...restProps
-->
