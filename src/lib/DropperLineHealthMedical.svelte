<script lang="ts">
  ...
  let {
    ...
    title,
    desc,
    ariaLabel = 'dropper line Health replace_ariaLabel Medical',
    ...restProps
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'dropper line Health replace_ariaLabel Medical'
@prop ...restProps
-->
